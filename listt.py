...
entry_task.pack(side=tk.LEFT, padx=12)

button_add_task = tk.Button(frame_input, text="Add Task", command=add_task)
button_add_task.pack(side=tk.LEFT, padx=12)

frame_tasks = tk.Frame(root)
frame_tasks.pack()

listbox_tasks = tk.Listbox(frame_tasks, width=60, height=12)
